...
from work.apps.aaa.config import CONFIG_MANAGER
from work.apps.aaa.references.pages import *
from work.apps.aaa.references.constants.strings import CLEAN_CHARS
...
class TestAAAEquities(unittest.TestCase):
    ...
    def setUp(self):
        self.config = CONFIG_MANAGER.get(AppConfigWebDriver, 'aaa_web')
