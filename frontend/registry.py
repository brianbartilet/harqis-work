...
TASK_REGISTRY: dict[str, WorkflowDef] = {
    ...
    'hud': {
        ...
        "tasks": [
            ...
            {
                "key":         'show_tcg_sell_cart',
                "label":       'Show Tcg Sell Cart',
                "task_path":   'workflows.hud.tasks.hud_tcg.show_tcg_sell_cart',
                "queue":       'tcg',
                "schedule":    'Daily at midnight',
                "kwargs":      {'cfg_id__tcg_mp': 'TCG_MP', 'worker_count': 3},
                "description": '',
                "manual_only": False,
            },
            {
                "key":         'show_jira_board',
                "label":       'Show Jira Board',
                "task_path":   'workflows.hud.tasks.hud_jira.show_jira_board',
                "queue":       'peon',
                "schedule":    'Scheduled (Mon–Fri)',
                "kwargs":      {'cfg_id__jira': 'JIRA', 'board_id': 1790, 'dashboard_id': 24135, 'repository_id': 24135, 'structure_id': 616},
                "description": '',
                "manual_only": False,
            },
            {
                ...
                "kwargs":      {'cfg_id__desktop': 'DESKTOP', 'cfg_id__calendar': 'GOOGLE_APPS', 'model': 'claude-haiku-4-5-20251001'},
        ...
        "tasks": [
            {
                ...
                "kwargs":      {'cfg_id__tcg_mp': 'TCG_MP', 'cfg_id__echo_mtg': 'ECHO_MTG', 'cfg_id__echo_mtg_fe': 'ECHO_MTG_FE', 'cfg_id__scryfall': 'SCRYFALL', 'limit': 100},
            ...
            },
            {
                ...
                "kwargs":      {'cfg_id__tcg_mp': 'TCG_MP', 'cfg_id__echo_mtg': 'ECHO_MTG', 'cfg_id__echo_mtg_fe': 'ECHO_MTG_FE', 'limit': 100},
    ...
    'desktop': {
        ...
        "tasks": [
            ...
            },
            {
                ...
                "kwargs":      {'hud_item_name': 'DESKTOP LOGS', 'logs_output_path': 'C:/Users/brian/GIT/harqis-work/logs/daily', 'model': 'claude-haiku-4-5-20251001'},
            ...
            },
            {
                ...
                "kwargs":      {'logs_daily_path': 'C:/Users/brian/GIT/harqis-work/logs/daily', 'logs_output_path': 'C:/Users/brian/GIT/harqis-work/logs/weekly', 'model': 'claude-haiku-4-5-20251001'},
