...
def test_agent_calls_tool_then_finishes(open_profile, sample_card):
    ...
    with patch("anthropic.Anthropic") as mock_anthropic:
        ...
        with patch("agents.projects.agent.tools.filesystem.ReadFileTool.run") as mock_read:
...
def test_agent_stops_at_max_iterations(open_profile, sample_card):
    ...
    with patch("anthropic.Anthropic") as mock_anthropic:
        ...
        with patch("agents.projects.agent.tools.kanban_tools.TrelloCommentTool.run") as mock_comment:
