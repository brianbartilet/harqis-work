"""
Tests for the TrelloClient adapter.
...
from agents.projects.trello.models import KanbanCard, KanbanColumn, KanbanChecklist
...
@pytest.fixture()
def provider():
    return TrelloClient(api_key=FAKE_KEY, token=FAKE_TOKEN)
