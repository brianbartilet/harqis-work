...
Was `agents.kanban.adapters.trello.TrelloProvider` before the Jira-drop and
provider-abstraction collapse. The class is plain — no ABC, no factory —
because Trello is the only supported backend.
"""
