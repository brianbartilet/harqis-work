---
name: create-new-ingest-source-hfl
description: >
  Scaffold a new Homework-for-Life ingest source under workflows/hfl that captures,
  distills, and dual-writes entries to Markdown and Elasticsearch.
user-invocable: true
