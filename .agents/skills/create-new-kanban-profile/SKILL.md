---
name: create-new-kanban-profile
description: >
  Scaffold a new agent profile under agents/projects/profiles/examples, register
  placeholder Mode A env vars, and print the manual Trello setup checklist.
user-invocable: true
...
| `--display-name "..."` | No | Human-readable name shown in signed comments and on the bot's eventual Trello profile. Default: `"Agent · <Name>"`. |
...
display_default: "Agent · Finance"     # the visible persona name
