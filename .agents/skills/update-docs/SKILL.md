...
name: update-docs
description: >
  Sweep README.md or a targeted doc against the live codebase, surface drift, and apply
  the smallest necessary documentation edits.
user-invocable: true
...
- Skill docs in `.agents/skills/*/SKILL.md` that mention `python scripts/deploy.py …`
