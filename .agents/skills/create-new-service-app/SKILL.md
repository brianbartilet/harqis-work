---
name: create-new-service-app
description: >
  Scaffold a complete app integration under apps from an OpenAPI spec, docs URL, or
  named stub, including service-layer conventions and validation.
user-invocable: true
...
Next steps:
  ...
  [ ] Restart the MCP server / active agent client to load the new tools
